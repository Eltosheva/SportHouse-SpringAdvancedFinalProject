...
public class SpringMailConfig implements ApplicationContextAware, EnvironmentAware {
    ...
    public JavaMailSender mailSender() throws IOException {
        ...
        mailSender.setHost(AppConstants.HOST);
        mailSender.setPort(AppConstants.PORT);
        mailSender.setProtocol(AppConstants.PROTOCOL);
        mailSender.setUsername(AppConstants.USERNAME);
        mailSender.setPassword(AppConstants.PASSWORD);
    ...
    private ITemplateResolver textTemplateResolver() {
        ...
        templateResolver.setCharacterEncoding(AppConstants.EMAIL_TEMPLATE_ENCODING);
